...
;
(function() { this.JST || (this.JST = {}); this.JST["packages/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\nSublimePackagesEvaluator.Views.PackageView = Backbone.View.extend({\n\n  initialize: function(){\n    // this.listenTo(this.model, \'destroy\', this.remove)\n    this.listenTo(this.model, \'all\', this.render);   \n  },\n\n  tagName: \'li\',\n\n  template: _.template($(\'#package-template\').html()),\n  editTemplate: _.template($(\'#edit-package-template\').html()),\n  render: function(){\n    this.$el.empty();\n    var renderedHTML = this.template(this.model.attributes);\n    this.$el.html(renderedHTML);\n    return this;\n  },\n\n  events: {\n    // \'click [data-action="release"]\' : \'releasePackage\',\n    \'click [data-action="edit"]\' : \'renderEditForm\',   \n  },\n\n  // releasePackage: function(){\n  //   this.model.destroy();\n  //   return this;\n  // },\n\n  renderEditForm: function(){\n    var that = this;\n\n    this.$el.html( this.editTemplate(this.model.attributes) );\n    this.$el.find(\'form.edit-package-form\').on(\'submit\', function(e){\n      e.preventDefault();\n      var nameField = that.$el.find("input[name=\'package-name\'");\n      var newName = nameField.val();\n      that.model.set(\'name\', newName);\n      that.model.save(); // ***   add save() for connecting Backbone with Rails   ***\n    })   \n    return this;\n  },\n\n});\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('   \n      <form class="edit-review-form">\n        Package: <input type="text" id="package_name" value=\'',(''+ package_name ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'\'></br>\n\n        Title: <input type="text" id="title" value=\'',(''+ title ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'\'></br>\n\n        Description:</br>\n        <textarea id="description" rows="5" cols="30">',(''+ description ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</textarea></br>\n        \n        <label for="review-platform">Platform: ',(''+  platform ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</label></br>\n        <label for="win">WIN</label>\n        <input type="radio" id="win" name="review-platform" value="win">    \n        <label for="osx">OS X</label>\n        <input type="radio" id="osx" name="review-platform" value="osx">        \n        <label for="linux">LINUX</label>\n        <input type="radio" id="linux" name="review-platform" value="linux"><br>        \n\n        <label for="review-rating">Rating: ',(''+ rating ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</label></br>\n        <label for="poor">1: poor</label>\n        <input type="radio" id="poor" name="review-rating" value="1">\n        <label for="fair">2: fair</label>\n        <input type="radio" id="fair" name="review-rating" value="2">\n        <label for="good">3: good</label>\n        <input type="radio" id="good" name="review-rating" value="3">\n        <label for="very_good">4: very good</label>\n        <input type="radio" id="very_good" name="review-rating" value="4">\n        <label for="excellent">5: excellent</label>\n        <input type="radio" id="excellent" name="review-rating" value="5"></br>\n\n        <button>Update</button>         \n      </form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/review"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n      <ul class="review">\n        Package: ',(''+ package_name ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</br>         \n        Title: ',(''+ title ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</br>\n        Description: ',(''+ description ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</br>        \n        Platform: ',(''+ platform ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</br>\n        Rating: ',(''+ rating ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</br>\n        Datetime: ',(''+ datetime ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</br>       \n        <button data-action=\'edit\'>Edit</button>\n        <button data-action=\'release\'>Delete</button>\n      </ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('      <form class="edit-user-form"> \n        <input type="text" placeholder=\'',(''+ email ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'\'>       \n      </form>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["users/user"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n      <ul class="user">\n        ',(''+ email ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' likes to review Sublime packages.  \n        <button data-action=\'release\'>Delete</button>\n        <button data-action=\'edit\'>Edit</button>\n      </ul>\n');}return __p.join('');};
}).call(this);
...
SublimePackagesEvaluator.Routers.Packages = Backbone.Router.extend({
...
var packages = [{
  ...
  "st_versions": [2, 3], 
  "last_modified": "2013-08-09T11:00:00Z", 
  "first_seen": "2011-12-15T14:08:17Z", 
  "trending_rank": null, 
  "author": "Will Bond (wbond)", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 2427954, 
  "missing_error": ""
}, {
  "installs_rank": 2, 
  ...
  "name": "Emmet", 
  "st_versions": [2, 3], 
  "last_modified": "2014-06-17T14:38:39Z", 
  "first_seen": "2012-08-29T08:46:34Z", 
  "trending_rank": null, 
  "author": "sergeche", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 574047, 
  "missing_error": ""
}, {
  "installs_rank": 3, 
  ...
  "name": "SublimeLinter", 
  "st_versions": [2, 3], 
  "last_modified": "2014-07-21T15:11:22Z", 
  "first_seen": "2011-12-15T14:11:51Z", 
  "trending_rank": null, 
  "author": "SublimeLinter", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 384135, 
  "missing_error": ""
}, {
  "installs_rank": 4, 
  ...
  "name": "Theme - Soda", 
  "st_versions": [2, 3], 
  "last_modified": "2014-05-07T06:11:27Z", 
  "first_seen": "2011-12-15T14:14:13Z", 
  "trending_rank": null, 
  "author": "buymeasoda", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 373108, 
  "missing_error": ""
}, {
  "installs_rank": 5, 
  ...
  "st_versions": [3], 
  "last_modified": "2014-07-12T13:35:00Z", 
  "first_seen": "2011-12-15T15:25:10Z", 
  "trending_rank": null, 
  "author": "titoBouzout", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 371773, 
  "missing_error": ""
}, {
  "installs_rank": 6, 
  ...
  "name": "HTML5", 
  "st_versions": [2, 3], 
  "last_modified": "2014-02-02T19:13:59Z", 
  "first_seen": "2011-12-15T14:13:43Z", 
  "trending_rank": null, 
  "author": "mrmartineau", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 337532, 
  "missing_error": ""
}, {
  "installs_rank": 7, 
  ...
  "st_versions": [2, 3], 
  "last_modified": "2013-09-21T00:00:00Z", 
  "first_seen": "2011-12-15T14:11:03Z", 
  "trending_rank": 89, 
  "author": "German M. Bravo (Kronuz)", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 337500, 
  "missing_error": ""
}, {
  "installs_rank": 8, 
  ...
  "st_versions": [2, 3], 
  "last_modified": "2014-06-27T17:47:38Z", 
  "first_seen": "2011-12-15T14:39:30Z", 
  "trending_rank": null, 
  "author": "facelessuser", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 324159, 
  "missing_error": ""
}, {
  "installs_rank": 9, 
  ...
  "name": "Alignment", 
  "st_versions": [2, 3], 
  "last_modified": "2013-08-08T08:41:47Z", 
  "first_seen": "2011-12-15T14:23:49Z", 
  "trending_rank": null, 
  "author": "Will Bond (wbond)", 
  "is_missing": false, 
  "platforms": ["windows", "osx", "linux"], 
  "unique_installs": 286684, 
  "missing_error": ""
}, {
  "installs_rank": 10, 
  ...
  "name": "SFTP", 
  "st_versions": [2, 3], 
  "last_modified": "2014-02-07T13:00:00Z", 
  "first_seen": "2011-12-15T14:11:26Z", 
  "trending_rank": null, 
  "author": "Will Bond (wbond)", 
  "is_missing": false, 
  "platforms": ["osx", "linux", "windows"], 
  "unique_installs": 250757, 
  "missing_error": ""
}];
// window.SublimePackagesEvaluator = {
//   Models: {},
